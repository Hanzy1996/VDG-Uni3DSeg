...
model = dict(
    ...
    decoder=dict(
        ...
        num_img_prototype=5,
        des_clip_file='class_description/clip_embedding/scannet200_llama_v3_description.npy',
        img_clip_file='internet_image/image_clip_feat/scannet200_image_clip_top5.json',
        window_size=128),
    criterion=dict(
        type='ScanNetUnifiedCriterion_contrast',
        num_semantic_classes=num_semantic_classes,
        sem_criterion=dict(
...
data_root = '/home/hisham/zongyan/datasets/oneformer3d_scannet200/scannet200/'
data_prefix = dict(
    pts='points',
...
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=512, dynamic_intervals=[(1, 16), (512 - 16, 1)])
