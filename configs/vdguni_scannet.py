...
model = dict(
    ...
    decoder=dict(
        ...
        num_img_prototype=5,
        des_clip_file='class_description/clip_embedding/scannet_llama_v3_description.npy',
        img_clip_file='internet_image/image_clip_feat/scannet_image_clip_top5.json',
        window_size=128,
        ),
    criterion=dict(
