...
parser.add_argument('--dataset', default='scannet200', help='name of the dataset')
parser.add_argument(
    '--root-path',
    type=str,
    default='/l/users/rao.anwer/zongyan/datasets/scannet_test_segments',
    help='specify the root path of dataset')
parser.add_argument(
    '--out-dir',
    type=str,
    default='/l/users/rao.anwer/zongyan/datasets/scannet200_oneformer',
    required=False,
    help='name of info pkl')
parser.add_argument('--extra-tag', type=str, default='scannet200')
parser.add_argument(
